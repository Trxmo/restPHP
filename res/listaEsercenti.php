...
<style>
    ...
    .demo-card-image.mdl-card {
        width: 256px;
        height: 256px;
        background: url('../../res/no_image.jpg') center / cover;
    }
...
ob_start();
require '../backEnd_json/lista_esercenti.php';
$output = ob_get_clean();
...
if($esercenti == null){
    ...
    foreach ($esercenti as $esercente) {
        ...
        echo '" href="visualizzaEsercente.php?id=' . $esercente['id_amministratore'] . '">
                <div class="demo-card-image mdl-card mdl-shadow--2dp" ';

        if (ottieniImmagine($esercente['percorso_logo']) == "proxyImage.php?pic=") {
            echo '>';
        } else {
