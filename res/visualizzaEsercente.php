...
<div class="demo-card-wide mdl-card mdl-shadow--2dp">
  ...
  <!--  <div class="mdl-card__title">
        <h2 class="mdl-card__title-text">Questionario associato a Qr Code</h2>
    </div>
    <div class="mdl-card__supporting-text">
        <table class="mdl-data-table mdl-js-data-table mdl-data-table mdl-shadow--2dp">
        <th class="mdl-data-table__cell--non-numeric">MODIFICA</th>
        <th class="mdl-data-table__cell--non-numeric">Titolo</th>
        <th>Id</th>
        <th class="mdl-data-table__cell--non-numeric">Struttura</th>
        <th class="mdl-data-table__cell--non-numeric">Grafico</th>
        <th class="mdl-data-table__cell--non-numeric">PDF</th>
        <tr>
        <td class="mdl-data-table__cell--non-numeric"><a onclick="dialog()" class="bottone mdl-button mdl-js-button mdl-button--fab mdl-button--mini-fab">
              <i class="material-icons">edit</i>
            </a>
        </td>
        <td class="mdl-data-table__cell--non-numeric">asddaskjd</td>
        <td>asddaskjd</td>
        <td class="mdl-data-table__cell--non-numeric">asddaskjd</td>
        <td class="mdl-data-table__cell--non-numeric">asddaskjd</td>
        <td class="mdl-data-table__cell--non-numeric">asddaskjd</td>
    ...
    <div class="mdl-card__title">
        <a class="mdl-button mdl-js-button mdl-js-ripple-effect" style="margin: auto;color:white;"
           href="<?php echo "creaQuestionario.php?id=" . $id . "&mail=" . $esercente['email']; ?>">
            Crea Questionario
        </a>
    </div>
</div>
...
<!--<div class="mdl-card__supporting-text">
<table id="dialog" class="mdl-data-table mdl-js-data-table mdl-data-table mdl-shadow--2dp">
<th class="mdl-data-table__cell--non-numeric">MODIFICA</th>
<th class="mdl-data-table__cell--non-numeric">Titolo</th>
<th>Id</th>
<th class="mdl-data-table__cell--non-numeric">Struttura</th>
