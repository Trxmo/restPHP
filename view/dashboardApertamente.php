...
include __DIR__ . "/parcials/header.php";
?>
...
<div class="dashboard">
    ...
    <div class="demo-card-wide mdl-card mdl-shadow--2dp" style="margin-left: 5%;">
        <div class="mdl-card__title" style="height: 150px;">
            <h2 class="mdl-card__title-text">Lista Esercenti</h2>
        </div>
        <div class="mdl-card__supporting-text">
            ...
            <ul class="demo-list-two mdl-list">
                ...
                ob_start();
//                require '../backEnd_json/ottieni_questionari_dashboard.php';
                $output = ob_get_clean();
        ...
        <div class="mdl-card__title">
            <a class="mdl-button mdl-js-button mdl-js-ripple-effect" href="esercenti.php"
            style="margin: auto;">
...
<?php
include __DIR__ . "/parcials/footer.php";
?>
